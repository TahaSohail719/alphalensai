      ...
      <header className="h-14 sm:h-16 border-b border-border/50 bg-card/80 backdrop-blur-xl sticky top-0 z-50 shadow-sm">
        <div className="h-full px-3 sm:px-4 lg:px-6">
          <div className="flex items-center justify-between h-full max-w-7xl mx-auto">
            ...
            >
              <div className="w-8 h-8 sm:w-9 sm:h-9 gradient-primary rounded-lg sm:rounded-xl flex items-center justify-center shadow-lg group-hover:shadow-xl transition-all duration-200">
                <TrendingUp className="h-4 w-4 sm:h-5 sm:w-5 text-primary-foreground" />
              </div>
              <div className="hidden sm:block">
                <h1 className="text-lg sm:text-xl font-bold bg-gradient-to-r from-primary to-primary/70 bg-clip-text text-transparent">TradeMind</h1>
                <p className="text-xs text-muted-foreground">AI Trading Intelligence</p>
              </div>
            </button>
            ...
            <div className="flex items-center gap-2 sm:gap-4">
              <div className="hidden sm:flex items-center gap-2 text-sm text-muted-foreground bg-card/50 px-3 py-1.5 rounded-full border border-border/50">
                ...
                <span className="hidden md:inline">Live Markets</span>
